...
function CONTRIBUTIN(){
  GEBI("d0").href="http://imtranslator.net"+_CGI+"&a=0";
  GEBI("d1").href="http://imtranslator.net"+_CGI+"&a=5";
  GEBI("d2").href="http://imtranslator.net"+_CGI+"&a=10";
  GEBI("d3").href="http://imtranslator.net"+_CGI+"&a=20";
  GEBI("d4").href="http://imtranslator.net"+_CGI+"&a=0";
}
