        ...
        _createFontSelect : function() {
            ...
            c = ed.controlManager.createListBox('fontselect', {
                ...
                onselect : function(v) {
                    ...
                    //Gliffy mod: if the user selects the same thing
                    //that was already selected, do nothing, instead of clearing
                    //the font style
                    if ($('#gliffy-edit-text_ifr').is(":visible") && cur && cur.value === v){
                        return false;
                    }
        ...
        _createFontSizeSelect : function() {
            ...
            if (c) {
                each(t.settings.theme_advanced_font_sizes, function(v, k) {
                    ...
                    //GLIFFY MOD: don't show gigantic font sizes in the drop down menu.
...
//            });
        ...
        _gliffyLink : function(ui,val){
            var ed = this.editor;
            if (ed.gliffyLinkFunc && ed.gliffyTextControl){
                ed.gliffyLinkFunc(ed.gliffyTextControl, ed);
            }
            else{
                this._mceLink(ui,val);
            }
        },
