(function() {
    ...
    function Body({data, actions}) {
        ...
        let textNode;
        const wrapper =
            data.settings.theme.engine === ThemeEngines.staticTheme
                ? {
                ...
                : data.settings.theme.engine === ThemeEngines.cssFilter ||
                  data.settings.theme.engine === ThemeEngines.svgFilter
                ? {
