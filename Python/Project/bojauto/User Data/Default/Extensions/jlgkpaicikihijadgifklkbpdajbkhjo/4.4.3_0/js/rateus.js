...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_stylis_stylis_min__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis_rule_sheet__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_is__ = __webpack_require__(326);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_memoize_one__ = __webpack_require__(328);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_prop_types__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__emotion_is_prop_valid__ = __webpack_require__(329);
...
function createGlobalStyle(strings) {
  ...
  GlobalStyleComponent.styledComponentId = id;
   false ? GlobalStyleComponent.propTypes = {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(27), __webpack_require__(323)(module)))
...
newElement.id = "crxMouseRateUs";
document.body.appendChild(newElement);

(0, _reactDom.render)(_react2.default.createElement(_Main.Main, null), document.querySelector('#crxMouseRateUs'));
...
var _RateUsOptions = __webpack_require__(321);
...
var Main = exports.Main = function (_React$Component) {
    ...
    function Main(props) {
        ...
        _this.state = {
            currentView: _constants.overlayViews.RateUsOptions
        };
    ...
    _createClass(Main, [{
        ...
        value: function render() {
            ...
            switch (currentView) {
                case _constants.overlayViews.none:
                    return null;
                case _constants.overlayViews.RateUsOptions:
                    return React.createElement(_RateUsOptions.RateUsOptions, { changeView: this.changeView });
            }
        }
    }]);
...
exports.RateUsOptions = undefined;
...
var _sharedStyledComponents = __webpack_require__(322);

var _sharedStyledComponents2 = _interopRequireDefault(_sharedStyledComponents);

var _styledComponents = __webpack_require__(100);
...
var Smiley = _styledComponents2.default.img(_templateObject);

var Title = _styledComponents2.default.div(_templateObject2);

var Stars = _styledComponents2.default.div(_templateObject3);

var Buttons = _styledComponents2.default.div(_templateObject4);

var Star = _styledComponents2.default.img(_templateObject5);

var RateUsOptions = exports.RateUsOptions = function (_React$Component) {
    _inherits(RateUsOptions, _React$Component);

    function RateUsOptions(props) {
        _classCallCheck(this, RateUsOptions);

        var _this = _possibleConstructorReturn(this, (RateUsOptions.__proto__ || Object.getPrototypeOf(RateUsOptions)).call(this, props));
        ...
        _this.openChromeStorePage = _this.openChromeStorePage.bind(_this);
        _this.openGoogleForm = _this.openGoogleForm.bind(_this);
        _this.neverShowAgain = _this.neverShowAgain.bind(_this);
        _this.remindMeLater = _this.remindMeLater.bind(_this);
        _this.unmountComponent = _this.unmountComponent.bind(_this);
        return _this;
    }

    _createClass(RateUsOptions, [{
        key: 'changeRating',
        ...
        key: 'openChromeStorePage',
        value: function openChromeStorePage(star) {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: "Rate Us", gaAction: "Rated", gaLabel: star });
            var chromeStorePage = 'https://chrome.google.com/webstore/detail/crxmouse-chrome-gestures/jlgkpaicikihijadgifklkbpdajbkhjo';
            chrome.runtime.sendMessage({ type: 'openNewTab', url: chromeStorePage });
            chrome.runtime.sendMessage({ type: 'neverShowAgainRateUs' });
            this.unmountComponent();
        }
    }, {
        key: 'openGoogleForm',
        value: function openGoogleForm(star) {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: "Rate Us", gaAction: "Rated", gaLabel: star });
            var googleFormPage = 'https://docs.google.com/forms/d/1TEfvmTUmx0XHBU5n-KV8cWJ_Z87-rvqCkP5EVQmg4e4';
            chrome.runtime.sendMessage({ type: 'openNewTab', url: googleFormPage });
            chrome.runtime.sendMessage({ type: 'neverShowAgainRateUs' });
            this.unmountComponent();
        }
    }, {
        ...
        value: function neverShowAgain() {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: "Rate Us", gaAction: "Don't show again" });
            chrome.runtime.sendMessage({ type: 'neverShowAgainRateUs' });
            this.unmountComponent();
        }
    }, {
        key: 'remindMeLater',
        value: function remindMeLater() {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: "Rate Us", gaAction: "Remind me" });
            this.unmountComponent();
        }
    }, {
        ...
        value: function unmountComponent() {
            ...
            setTimeout(function () {
                changeView(_constants.overlayViews.none);
            }, 1000);
        }
    }, {
        key: 'componentDidMount',
        value: function componentDidMount() {
            chrome.runtime.sendMessage({ type: "gaEvent", gaCategory: "Rate Us", gaAction: "Shown" });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var _state = this.state,
                ...
                userAction = _state.userAction;

            return React.createElement(
                _sharedStyledComponents2.default,
                { userAction: userAction },
                React.createElement(Smiley, { src: chrome.extension.getURL('image/rating/' + rating + '-stars.svg') }),
                React.createElement(
                    Title,
                    null,
                    chrome.i18n.getMessage('rate_us_title')
                ),
                React.createElement(
                    Stars,
                    null,
                    React.createElement(Star, { onClick: function onClick() {
                            return _this2.openGoogleForm('1');
                        }, onMouseEnter: function onMouseEnter() {
                            return _this2.changeRating(1);
                        }, src: chrome.extension.getURL('image/rating/star' + (rating >= 1 ? 'full' : '') + '.svg') }),
                    React.createElement(Star, { onClick: function onClick() {
                            return _this2.openGoogleForm('2');
                        }, onMouseEnter: function onMouseEnter() {
                            return _this2.changeRating(2);
                        }, src: chrome.extension.getURL('image/rating/star' + (rating >= 2 ? 'full' : '') + '.svg') }),
                    React.createElement(Star, { onClick: function onClick() {
                            return _this2.openGoogleForm('3');
                        }, onMouseEnter: function onMouseEnter() {
                            return _this2.changeRating(3);
                        }, src: chrome.extension.getURL('image/rating/star' + (rating >= 3 ? 'full' : '') + '.svg') }),
                    React.createElement(Star, { onClick: function onClick() {
                            return _this2.openChromeStorePage('4');
                        }, onMouseEnter: function onMouseEnter() {
                            return _this2.changeRating(4);
                        }, src: chrome.extension.getURL('image/rating/star' + (rating >= 4 ? 'full' : '') + '.svg') }),
                    React.createElement(Star, { onClick: function onClick() {
                            return _this2.openChromeStorePage('5');
                        }, onMouseEnter: function onMouseEnter() {
                            return _this2.changeRating(5);
                        }, src: chrome.extension.getURL('image/rating/star' + (rating >= 5 ? 'full' : '') + '.svg') })
                ),
                React.createElement(
                    Buttons,
                    null,
                    React.createElement(
                        ...
                        chrome.i18n.getMessage('rate_us_never_show_again')
                    ),
                    React.createElement(
                        'div',
                        { onClick: this.remindMeLater },
                        chrome.i18n.getMessage('rate_us_remind_me_later')
                    )
                )
            );
        }
...
var _templateObject = _taggedTemplateLiteral(['\n  0% {\n    opacity: 0;\n  }\n\n  100% {\n    opacity: 1;\n  }\n'], ['\n  0% {\n    opacity: 0;\n  }\n\n  100% {\n    opacity: 1;\n  }\n']),
    _templateObject2 = _taggedTemplateLiteral(['\n  0% {\n    opacity: 1;\n  }\n\n  100% {\n    opacity: 0;\n  }\n'], ['\n  0% {\n    opacity: 1;\n  }\n\n  100% {\n    opacity: 0;\n  }\n']),
    _templateObject3 = _taggedTemplateLiteral(['\n    width: 385px;\n    height: 302px;\n    border-radius: 4px;\n    box-shadow: 0 11px 27px 0 rgba(0, 0, 0, 0.27);\n    border: solid 1px rgba(0, 0, 0, 0.2);\n    background-color: #ffffff;\n    position: fixed;\n    top: 22px;\n    right: 38px;\n    z-index: 2147483647;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    opacity: ', ';\n    animation: ', ' 1s linear;\n'], ['\n    width: 385px;\n    height: 302px;\n    border-radius: 4px;\n    box-shadow: 0 11px 27px 0 rgba(0, 0, 0, 0.27);\n    border: solid 1px rgba(0, 0, 0, 0.2);\n    background-color: #ffffff;\n    position: fixed;\n    top: 22px;\n    right: 38px;\n    z-index: 2147483647;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    opacity: ', ';\n    animation: ', ' 1s linear;\n']);
...
var opacityIn = (0, _styledComponents.keyframes)(_templateObject);

var opacityOut = (0, _styledComponents.keyframes)(_templateObject2);

var Overlay = _styledComponents2.default.div(_templateObject3, function (props) {
  return !props.userAction ? 1 : 0;
}, function (props) {
  return !props.userAction ? opacityIn : opacityOut;
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(330);
